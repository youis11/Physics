...
void ModulePhysics::CreateRectangle() {
	...
	polygonShape.SetAsBox(0.80, 0.40); //a 4x2 rectangle
...
void ModulePhysics::CreateChain() {
	...
	for (int i = 0; i < 12; i++) {
		vector[i].Set(PIXEL_TO_METERS(points[i * 2]), PIXEL_TO_METERS(points[i * 2 + 1]));
	}

	b2ChainShape chainShape;
	fixture.shape = &chainShape;
	chainShape.CreateLoop(vector, 12); //a 4x2 rectangle
